...
// Local libraries
import Send from '../../../../src/use-cases/tx-types/send.js'
import mockDataLib from '../../mocks/send-mock.js'
...
describe('#send.js', () => {
  ...
  describe('#constructor', () => {
    it('should throw error if adapters are not passed in', () => {
      try {
        ...
        assert.equal(
          err.message,
          'Adapters are required for the send.js use case library.'
        )
      }
    })
  })
  ...
  describe('#subtractTokensFromInputAddr', () => {
    it('should subtract tokens from the input address', async () => {
      ...
      uut.adapters.addrDb.getAddr.resolves(mockData.addrData01)
    ...
    it('should skip an input if it was marked invalid', async () => {
      ...
      uut.adapters.txDb.getTx.reset()
      uut.adapters.txDb.getTx.resolves(mockData.invalidTxFromDb01)
